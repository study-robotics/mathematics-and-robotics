...
class Decoder(torch.nn.Module):
    ...
    def forward(self, voxel_features):
        #print(voxel_features.size()) # torch.Size([32, 1, 512, 4, 4, 4])
        ...
        for features in voxel_features:
            ...
            raw_feature = torch.cat((raw_feature, Cspace), dim=1)
        ...
        raw_features = torch.stack(raw_features).permute(1, 0, 2, 3, 4).contiguous()
        #print(Cspaces.size())
        return raw_features, Cspaces
