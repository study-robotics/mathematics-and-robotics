...
pointsN2 = L2*L2
loop_counter = 0 #接触判定した回数（階層式ではないため単純に181*361)
...
#図の表示は時間に含まない
#1回目elapsed_time:11.43419075012207[sec]
#2回目elapsed_time:11.200932741165161[sec]
#3回目elapsed_time:11.382166385650635[sec]
#4回目elapsed_time:11.220746278762817[sec]
#5回目elapsed_time:11.314634561538696[sec]
#5回の平均#11.3105341434
print("loop-cunter", loop_counter)
print("hit-counter", hit_counter)
#loop-cunter 65341(階層式ではないため単純に181×361)
#hit-counter 14737
